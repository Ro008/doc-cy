    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-md overflow-hidden rounded-3xl border border-clinical-300/20 bg-slate-900/95 shadow-2xl shadow-ink-900/30 backdrop-blur-xl">
