...
const secondaryLinkClass =
  "inline-flex min-h-8 items-center whitespace-nowrap rounded-lg border border-clinical-500 bg-clinical-500 px-3 text-sm font-semibold leading-none text-white shadow-[0_1px_2px_rgba(18,184,192,0.22)] transition hover:border-clinical-600 hover:bg-clinical-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-clinical-400 focus-visible:ring-offset-2 focus-visible:ring-offset-ink-50";

const menuLoginClass =
  "flex w-full items-center rounded-[0.9rem] border border-ink-200 bg-white px-3.5 py-2.5 text-left text-[13px] font-medium leading-snug text-ink-700 no-underline transition hover:border-clinical-300 hover:bg-clinical-50 hover:text-ink-900";

const menuSecondaryClass =
  "flex w-full items-center rounded-[0.9rem] bg-clinical-500 px-3.5 py-2.5 text-left text-[13px] font-semibold leading-snug text-white no-underline transition hover:bg-clinical-600";
