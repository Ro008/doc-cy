...
export const finderResultCardClass =
  "rounded-2xl border border-clinical-200 bg-white p-4 shadow-[0_1px_3px_rgba(26,43,60,0.06),0_4px_16px_rgba(18,184,192,0.05)] sm:p-5 motion-safe:transition-[transform,box-shadow,border-color] motion-safe:duration-200 motion-safe:ease-out hover:border-clinical-300 hover:shadow-[0_10px_28px_rgba(26,43,60,0.09),0_2px_8px_rgba(18,184,192,0.1)] motion-safe:hover:-translate-y-0.5";
