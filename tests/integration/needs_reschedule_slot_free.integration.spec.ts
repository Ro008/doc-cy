 ...
 * public bookings (overlap + partial unique index appointments_doctor_datetime_active_booking_key).
 */
test.describe("Integration: NEEDS_RESCHEDULE frees original slot", { tag: ["@pr-e2e", "@pr-e2e-booking"] }, () => {
