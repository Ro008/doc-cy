...
-- NEEDS_RESCHEDULE: original appointment_datetime is not occupied; only proposed_slots (2nd branch).
-- Backward expansion: new booking length slot_duration_minutes vs POST overlap (see expand script).
-- Keep in sync with: public_doctor_occupied_datetimes_expand_appointment_slots.sql
